...
<body>
  ...
  <div id="about" class="main-about-us" style="display: block">
    <div class="container-about">
      <p>ჩვენ შესახებ</p>
      <pre>Buytech - წარმოადგენს ონლაინ პლატფორმას, სადაც მომხმარებელს აქვს შესაძლებლობა სახლიდან გაუსვლელად, მარტივი პროცედურის გავლით, მიიღოს სასურველი ნივთი ქვეყნის  ნებისმიერ წერტილში.

ჩვენი უპირატესობები:</pre>
      <pre>• სწრაფი მიწოდების სერვისი მთელი საქართველოს მასშტაბით.
• სააქციოდ წარმოდგენილი ნივთების დიდი ასორტიმენტი.
• საგარანტიო სერვისი.
• 24/7 დახმარება.
• წარმოდგენილი ნივთის/ების დეტალურად აღწერა
• დაბრუნების პოლიტიკა</pre>
    </div>
    </div>
  </div>
