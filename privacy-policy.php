...
<head>
  ...
  <meta property="og:url" content="https://moco.ge/?id=<?php echo htmlspecialchars($product_link); ?>">
...
<body>
  ...
  <div id="about" class="main-about-us" style="display: block">
    <div class="container-about">
      <p>კონფიდენციალურობა</p>
     <pre>პერსონალური მონაცემები ნიშნას ნებისმიერ ინფორმაციას, რომელიც პირდაპირ ან ირიბად უკავშირდება კონკრეტულ ან იდენტიფიცირებად პირს (მოქალაქეს).
...
Buytech - თქვენი ნებართვის გარეშე არ უზიარებს თქვენს მიერ მოწოდებულ პერსონალურ ინფორმაციას მესამე მხარეს - თუმცა იტოვებს უფლებას მითითებულ საკონტაქტო ინფორმაციაზე გამოგიგზავნოთ სხვადასხვა ინფორმაცია ჩვენი სიახლეების,აქციების,განახლებების შესახებ.

რა დროით ვინახავთ პერსონალურ მონაცემებს?

თქვენს პერსონალურ ინფორმაციას ვინახავთ 2 წლამდე ვადით.

საიტის გამოყენებით თქვენ ეთანხმებით მოცემულ წესებს, წინააღმდეგ შემთხვევაში ნუ ისარგებლებთ ჩვენი კომპანიის მომსახურებით. </pre>
    </div>
  </div>
